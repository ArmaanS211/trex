...
function setup() {
  ...
  trex = createSprite(100,height - height/6.5 - 70,20,50);
  ...
  invisibleGround = createSprite(width/2,height - height/6.5-10,width,125);  
  invisibleGround.shapeColor = "#f4cbaa";
  
  ground = createSprite(width/2,height-height/6.5,width,2);
...
function spawnObstacles() {
  if(frameCount % 80 === 0) {
    var obstacle = createSprite(width,height-240,20,30);
    //obstacle.debug = true
